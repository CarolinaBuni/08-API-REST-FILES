...
const { getEvents, postEvents, deleteEvents, getEventsByID, getEventsByTitle, putEvents } = require( "../controllers/evento" );
...
eventsRoutes.put("/:id", [isAuth], upload.single("img"), putEvents);
